...
autocmd FileType python nnoremap <LocalLeader>ss :Ack! --python -w ""<Left>
autocmd FileType c  nnoremap <LocalLeader>ss :Ack! --cc -w ""<Left>
autocmd FileType cpp  nnoremap <LocalLeader>ss :Ack! --cpp -w ""<Left>
autocmd FileType ocaml  nnoremap <LocalLeader>ss :Ack! --ocaml -w ""<Left>
autocmd FileType markdown  nnoremap <LocalLeader>ss :Ack! --markdown -w ""<Left>
autocmd FileType java  nnoremap <LocalLeader>ss :Ack! --java -w ""<Left>
autocmd FileType javascript  nnoremap <LocalLeader>ss :Ack! --js -w ""<Left>
nnoremap <Leader>sp :Ack! --python -w ""<Left>
nnoremap <Leader>sc :Ack! --cc -w ""<Left>
nnoremap <Leader>sz :Ack! --cpp -w ""<Left>
nnoremap <Leader>so :Ack! --ocaml -w ""<Left>
nnoremap <Leader>sm :Ack! --markdown -w ""<Left>
nnoremap <Leader>sj :Ack! --java -w ""<Left>
nnoremap <Leader>sa :Ack! --js -w ""<Left>
